...
const BASE_IGNORE_TEXT = new Set([
  'H1', 'H2', 'H3', 'H4', 'H5', 'H6', 'Normal',
])

const NON_I18N_CALLS = new Set([
  'emit', 'import', 'querySelector', 'querySelectorAll',
  'createElement', 'getContext', 'getElementById',
  'getElementsByClassName', 'getAttribute', 'setAttribute',
